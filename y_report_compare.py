...
class YReportCompare(YReport):
    ...
    def __init__(self, request_id, info_crt, info_cmp, language='Korean'):
        ...
        self.path = os.path.join(request_id, 'y_report_compare.pdf')
    ...
    def function_abnormal_summary(self, subject):
        ...
        self.make_img('%s/cmp_stress.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.40, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        self.make_img('%s/crt_stress.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.40, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        ...
        self.make_img('%s/cmp_concentration.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.49, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        self.make_img('%s/crt_concentration.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.49, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        ...
        self.make_img('%s/cmp_cognition.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.58, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        self.make_img('%s/crt_cognition.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.58, self.const.X_LIM * 0.45, self.const.Y_LIM * 0.052)
        ...
        self.make_img('%s/cmp_brain_use.png' % self.request_id, self.const.X_LIM * 0.15, self.const.Y_LIM * 0.71, self.const.X_LIM * 0.32, self.const.Y_LIM * 0.160)
        self.make_img('%s/crt_brain_use.png' % self.request_id, self.const.X_LIM * 0.55, self.const.Y_LIM * 0.71, self.const.X_LIM * 0.32, self.const.Y_LIM * 0.160)
        ...
        self.make_img('%s/cmp_info_amount_complexity.png' % self.request_id, self.const.X_LIM * 0.15, self.const.Y_LIM * 0.354, self.const.X_LIM * 0.27,
                      self.const.Y_LIM * 0.11)
        self.make_img('%s/crt_info_amount_complexity.png' % self.request_id, self.const.X_LIM * 0.55, self.const.Y_LIM * 0.354, self.const.X_LIM * 0.27,
                      self.const.Y_LIM * 0.11)
        ...
        self.make_img('%s/cmp_info_speed.png' % self.request_id, self.const.X_LIM * 0.15, self.const.Y_LIM * 0.524, self.const.X_LIM * 0.30, self.const.Y_LIM * 0.12)
        self.make_img('%s/crt_info_speed.png' % self.request_id, self.const.X_LIM * 0.55, self.const.Y_LIM * 0.524, self.const.X_LIM * 0.30, self.const.Y_LIM * 0.12)
        ...
        self.make_img('%s/cmp_hemispheric_connectivity.png' % self.request_id, self.const.X_LIM * 0.15, self.const.Y_LIM * 0.694, self.const.X_LIM * 0.30,
                      self.const.Y_LIM * 0.144)
        self.make_img('%s/crt_hemispheric_connectivity.png' % self.request_id, self.const.X_LIM * 0.55, self.const.Y_LIM * 0.694, self.const.X_LIM * 0.30,
                      self.const.Y_LIM * 0.144)
    ...
    def functional_abnormal_desc_table(self, cmp_cdf_dict, crt_cdf_dict):
        ...
        self.make_img('%s/cmp_psd_sef.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.675, self.const.X_LIM * 0.47,
                      self.const.X_LIM * 0.45 * 0.6)

        self.make_img('%s/crt_psd_sef.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.675, self.const.X_LIM * 0.47,
                      self.const.X_LIM * 0.45 * 0.6)
    ...
    def power_page(self):
        ...
        for band, y_ratio in [('Delta', 0.24), ('Theta', 0.48), ('Alpha', 0.72)]:
            self.make_img('%s/cmp_abs_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.05, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)

            self.make_img('%s/cmp_rel_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.27, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)

            self.make_img('%s/crt_abs_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.52, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)

            self.make_img('%s/crt_rel_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.74, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)
    ...
    def power_ratio_page(self):
        ...
        for band, y_ratio in [('DAR', 0.24), ('TAR', 0.48), ('TBR', 0.72)]:
            self.make_img('%s/cmp_rat_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.12, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)
            self.make_img('%s/crt_rat_power_%s.png' % (self.request_id, band), self.const.X_LIM * 0.59, self.const.Y_LIM * y_ratio, self.const.X_LIM * 0.2,
                          self.const.X_LIM * 0.145)
            self.make_text(band, self.const.X_LIM * 0.05, self.const.Y_LIM * y_ratio - 60, 45, self.const.FUN_OVERALL_TEXT_COLOR,
                           self.const.FONT_ARIAL_MT)
    ...
    def alpha_peak_page(self):
        ...
        self.make_img('%s/cmp_alpha_peak_ch_11.png' % self.request_id, self.const.PEAK_O1_IMG_X, self.const.PEAK_IMG_Y - 200, self.const.PEAK_IMG_W, self.const.PEAK_IMG_H)
        self.make_img('%s/crt_alpha_peak_ch_11.png' % self.request_id, self.const.PEAK_O2_IMG_X, self.const.PEAK_IMG_Y - 200, self.const.PEAK_IMG_W, self.const.PEAK_IMG_H)

        self.make_img('%s/cmp_alpha_peak_ch_15.png' % self.request_id, self.const.PEAK_O1_IMG_X, self.const.PEAK_IMG_Y + 700, self.const.PEAK_IMG_W, self.const.PEAK_IMG_H)
        self.make_img('%s/crt_alpha_peak_ch_15.png' % self.request_id, self.const.PEAK_O2_IMG_X, self.const.PEAK_IMG_Y + 700, self.const.PEAK_IMG_W, self.const.PEAK_IMG_H)
    ...
    def connectivity_page(self):
        ...
        self.make_img('%s/cmp_connectivity_line.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.55, self.const.X_LIM * 0.4,
                      self.const.X_LIM * 0.4)

        self.make_img('%s/cmp_mi.png' % self.request_id, self.const.X_LIM * 0.05, self.const.Y_LIM * 0.26, self.const.X_LIM * 0.4,
                      self.const.X_LIM * 0.4)

        self.make_img('%s/crt_connectivity_line.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.55, self.const.X_LIM * 0.4,
                      self.const.X_LIM * 0.4)

        self.make_img('%s/crt_mi.png' % self.request_id, self.const.X_LIM * 0.5, self.const.Y_LIM * 0.26, self.const.X_LIM * 0.4,
                      self.const.X_LIM * 0.4)
